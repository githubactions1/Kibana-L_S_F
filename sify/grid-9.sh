...
api_url="http://sify.digitalrupay.com/apirt1/sify/dashboard/taskstsrprt"

# Define the Elastic index name
index_name="assigned-tasks-engineers-and-riggers"
...
curl -s -XPOST "http://localhost:9200/assigned-tasks-engineers-and-riggers/_doc/_bulk" -H "Content-Type: application/json" -H "Authorization: ApiKey V1FSQVhvZ0JhMVoyOXNxZ2RXNnM6alRIQkNua2VSZFN4ZU8wYVEwakx4dw==" --data-binary "@$output_file"
