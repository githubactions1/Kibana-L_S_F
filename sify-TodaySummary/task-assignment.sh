...
api_url="http://sify.digitalrupay.com/devapirt1/sify/dashboard/taskSmryalltaskassign"

# Define the Elastic index name
index_name="task-assignment"
...
curl -s -XPOST "http://localhost:9200/task-assignment/_doc/_bulk" -H "Content-Type: application/json" -H "Authorization: ApiKey V1FSQVhvZ0JhMVoyOXNxZ2RXNnM6alRIQkNua2VSZFN4ZU8wYVEwakx4dw==" --data-binary "@$output_file"
